...
// // app/tools/business-plan/ansoff/page.tsx
// "use client";

// import React, { useState } from "react";
// import {
// 	ansoffSections,
// 	ansoffShortDescriptions,
// 	ansoffDetailedDescriptions,
// } from "@/lib/config/configAnsoff";
...
// const Ansoff: React.FC = () => {
// 	// État pour stocker les membres de l'équipe par section
// 	const [cards, setCards] = useState<Record<string, TeamMember[]>>({
// 		marketPenetration: [],
// 		productDevelopment: [],
// 		marketDevelopment: [],
// 		diversification: [],
...
// 			<h1 className="text-2xl font-bold mb-6">Ansoff Matrix</h1>
...
//         `}
// 			>
// 				{ansoffSections.map((section) => (
// 					<SectionCard
// 						key={section.id}
// 						section={section}
// 						shortDescription={ansoffShortDescriptions[section.id]}
// 						onClick={() => openModal(section.id)}
// 						cardList={cards[section.id]}
...
// 						? ansoffDetailedDescriptions[modalState.sectionId]
// 						: undefined
// 				}
// 			/>
// 		</div>
