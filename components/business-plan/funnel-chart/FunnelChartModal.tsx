// components/business-plan/funnel-chart/FunnelChartModal.tsx
import React from "react";
import { X } from "lucide-react";
import { FunnelCard } from "@/types/funnel-chart";
...
export const FunnelChartModal: React.FC<FunnelChartModalProps> = ({
	isOpen,
	onClose,
	card,
	onSave,
			...
			>
				<div className="flex justify-between items-center p-6 border-b">
					<h2 className="text-xl font-semibold text-gray-800">
						{isNew ? "Nouvelle stratégie" : "Modifier la stratégie"}
					</h2>
					<button
						onClick={onClose}
				...
				<div className="p-6 space-y-6">
					...
					<div className="space-y-2">
						...
						<textarea
							...
							placeholder="Détaillez votre stratégie..."
						/>
					</div>
