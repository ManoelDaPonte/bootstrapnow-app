	...
	categories: [
		{
		  ...
		  question: "Quel type de stock devez-vous conserver pour assurer votre activité ?",
		  examples: [
		...
		},
		{
		  ...
		  question: "Comment gérez-vous les variations saisonnières de vos stocks ?",
		  examples: [
		...
		},
		{
		  ...
		  question: "Quel est votre délai moyen de commande et de réception des stocks ?",
		  examples: [
		...
		},
		{
			...
			question: "La vente à crédit est-elle courante dans votre secteur ? Les clients s'y attendent-ils ?",
			examples: [
		...
		},
		{
			...
			question: "Quelle sera votre politique en matière de crédit ? Quel montant de crédit accorderez-vous ? Quels sont les critères d'octroi du crédit ?",
			examples: [
		...
		},
		{
			...
			question: "Comment allez-vous vérifier la solvabilité des nouveaux clients ?",
			examples: [
		...
		},
		{
			...
			question: "Quelles conditions de crédit proposerez-vous à vos clients ?",
			examples: [
		...
		},
		{
			...
			question: "Comment traiterez-vous les clients qui paient lentement ?",
			examples: [
		...
		},
		{
			...
			question: "Quelle est votre politique en matière de paiements en retard et quand ferez-vous appel à un avocat ou une agence de recouvrement ?",
			examples: [
